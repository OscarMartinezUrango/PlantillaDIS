...
public class MainView extends VerticalLayout {
    ...
    public MainView() throws URISyntaxException, IOException, InterruptedException {
        ...
        APIfront serviceAPI = new APIfront();
        List<Persona> productos = serviceAPI.getAllProductos();
        ...
        grid.addColumn(Persona::getCategoria).setHeader("Categoría");
        grid.addColumn(Persona::getPrecio).setHeader("Precio");
        grid.addColumn(Persona::getEan13).setHeader("EAN-13");
